...
//         .then((v) => {
//           this.loggerService.log(this, 'canActivate => ' + className + '.' + methodKey + '[headers]', headers);
//           return v;
//         })
//         .then((v) => {
//           resolve(v);
//         })
//         .catch((error) => {
//           this.loggerService.error(this, 'canActivate => ' + className + '.' + methodKey + '[headers]', error);
//           reject(error);
//         });
//     });
//   }
