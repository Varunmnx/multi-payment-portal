export interface CashFreePaymentFailedWebhook {
  data: {
    order: {
      order_id: string;
      order_amount: number;
    ...
    payment: {
      ...
      payment_status: string; // e.g. "FAILED"
      ...
      payment_method: {
        ...
        // Could also include other methods (upi, card, wallet, etc.)
      };
  ...
  type: 'PAYMENT_FAILED_WEBHOOK'; // e.g. "PAYMENT_FAILED_WEBHOOK"
}
